...
public class DateTimeCompare {
	public static void main(String[] args) {
		// 2024년 2월 20일 13시 0분 0초
		LocalDateTime todayDateTime = LocalDateTime.of(2024,2,20,13,0,0);
		System.out.println("오늘 : " + todayDateTime);
		
		// 2024년 8월 1일 18시 20분 0초
		LocalDateTime endDateTime = LocalDateTime.of(2024,8,1,18,20,0);
		System.out.println("종강 : " + endDateTime);
		
		// A.isBefore(B)		: A 가 B보다 이전이면, true 아니면 false
		// A.isEqual(B)			: A 가 B보다 같으면, true 아니면 false
