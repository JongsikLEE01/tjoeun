...
// 예외 처리 : InputMismatchException -> 입력 시, 자료형이 입력메소드와 일치하지 않아서 발생하는 예외 상황
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				...
				// 숫자를 입력하지 않았으면 다시 반복해서 입력
				sc.next();		// 입력 스트림에 남아있는 엔터를 제거
				System.err.println("(0~5)번 사이의 정수를 입력...");
				continue;
			}
			...
			System.out.println(menuName + "를/을 공부...");
		} while (true);
